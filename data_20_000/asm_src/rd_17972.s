...
# %bb.0:
	...
	subsd	%xmm1, %xmm0
	movsd	%xmm0, 128(%rsp)
	movsd	152(%rsp), %xmm3                # xmm3 = mem[0],zero
	...
	pandn	%xmm2, %xmm0
	por	%xmm1, %xmm0
	movsd	128(%rsp), %xmm4                # xmm4 = mem[0],zero
...
# %bb.1:
	...
	callq	ceil
	movsd	%xmm0, 104(%rsp)
	movsd	120(%rsp), %xmm3                # xmm3 = mem[0],zero
...
# %bb.5:                                #   in Loop: Header=BB4_4 Depth=1
	movsd	96(%rsp), %xmm3                 # xmm3 = mem[0],zero
	movsd	104(%rsp), %xmm2                # xmm2 = mem[0],zero
	movaps	%xmm2, %xmm4
	movaps	%xmm3, %xmm0
	cmpunordsd	%xmm0, %xmm0
	movaps	%xmm0, %xmm1
	...
	pandn	%xmm2, %xmm0
	por	%xmm1, %xmm0
	movsd	144(%rsp), %xmm4                # xmm4 = mem[0],zero
